...
- `actionCatalog`：BLUE、RED、AMBER共38項回合行動及抽象裁決修正，其中12項為航空、防空、遠程火力、海上與水下等抽象作戰類型。
...
網頁使用 `data/demo-data.js`；`reference/` 內的 SQLite 與 Excel 為相同目錄資料的可攜式副本。三份資料版本目前均為 `2.2-ABSTRACT-ACTIONS`（2026-07-28）。
